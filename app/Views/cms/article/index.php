...
<?= $this->section('content') ?>
    <div class="card">
        <div class="card-header">
            <a href="<?= base_url('cms/article/add') ?>" class="btn btn-sm btn-outline-primary">TAMBAH</a>
        </div>
            ...
            <div class="modal-content">
                <div class="modal-body">
                    <div class="text-center my-3">
                        ...
                        <h5 class="my-3" style="color: #1f1f1f">Anda Yakin Ingin Menghapus Artikel Ini?</h5>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('#data').DataTable({
                ...
                serverSide: true,
                order: [],
                ajax: "<?= site_url('cms/article/loadData') ?>",
                columns: [
