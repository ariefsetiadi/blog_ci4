...
<?= $this->section('content') ?>
    <div class="card">
        ...
        <form action="<?= base_url('cms/category/update/' . $category['id']) ?>" method="post" class="form-horizontal">
            <div class="card-body">
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label for="title">Nama Kategori</label>
                            <input type="text" class="form-control <?php if($validation->getError('title')){ echo 'is-invalid'; } ?>" name="title" id="title" value="<?= $category['title']; ?>" placeholder="Nama Kategori">
