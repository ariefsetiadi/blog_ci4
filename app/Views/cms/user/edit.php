...
<?= $this->section('content') ?>
    <div class="card card-default">
        ...
        <form action="<?= base_url('cms/user/update/'. $user['id']) ?>" method="post" class="form-horizontal">
            <div class="card-body">
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label for="fullname">Nama Lengkap</label>
                            <input type="text" class="form-control <?php if($validation->getError('fullname')){ echo 'is-invalid'; } ?>" name="fullname" id="fullname" value="<?= $user['fullname']; ?>" placeholder="Nama Lengkap">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control <?php if($validation->getError('username')){ echo 'is-invalid'; } ?>" name="username" id="username" value="<?= $user['username']; ?>" placeholder="Username">
