...
<?= $this->section('content') ?>
    <div class="card">
        ...
        <div class="card-block">
            ...
            <form action="<?= base_url('cms/user/save') ?>" method="post">
                <div class="form-group row">
                    <label class="col-sm-3 col-form-label">Nama Lengkap</label>
                    <div class="col-sm-9">
                        <input type="text" class="form-control" name="fullname" id="fullname" value="<?= old('fullname'); ?>" placeholder="Nama Lengkap">
