    ...
    public function loadData()
    {
        ...
        return DataTable::of($builder)->addNumbering('no')
            ...
            ->add('action', function($data) {
                return '<a href="user/edit/' . $data->id . '" class="btn btn-warning mr-1">EDIT</a>
                        <a href="javscript:void(0)" class="btn btn-danger ml-1" data-href="user/delete/' . $data->id . '" onclick="confirmDelete(this)">HAPUS</a>';
            })
            ->toJson(true);
    }
